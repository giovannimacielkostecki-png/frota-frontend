...
export const abastecimentoAPI = {
  ...
  atualizar:(id, data) => api.put(`/abastecimentos/${id}`, data),
  deletar:  (id)       => api.delete(`/abastecimentos/${id}`),
};
// ── PNEUS ────────────────────────────────────
...
export const freteAPI = {
  ...
  atualizar:      (id, data)  => api.put(`/fretes/${id}`, data),
  deletar:        (id)        => api.delete(`/fretes/${id}`),
